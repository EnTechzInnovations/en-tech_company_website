...
(function () {
  ...
  /**
   * Contact Form Gmail Redirection
   */
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function (e) {
      ...
      const recipient = 'entechzinnovations@gmail.com';
      const mailBody = `Name: ${name}%0AEmail: ${email}%0AMessage: ${message}`;
      const gmailUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=${recipient}&su=${encodeURIComponent(subject)}&body=${mailBody}`;
  ...
  /**
   * Unique Mouse Aura Follower
   */
  const mouseAura = document.createElement('div');
  mouseAura.id = 'mouse-aura';
